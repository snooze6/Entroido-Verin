...
public class Twitah {
    ...
    public String tweetsPorHashtag(String hashtag) throws IOException,Oauth2Exception{
        HttpsURLConnection connection = null;
        ...
        try {
            ...
            //TODO: REFACTORIZAR
            URL url = new URL("https://api.twitter.com/1.1/search/tweets.json?q=%23"+hashtag+"&count=1");
            connection = (HttpsURLConnection) url.openConnection();
